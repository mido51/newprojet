	...
	<div class="row">
		<div class="col-lg-8 col-md-8">
			...
			<div class="property-single-item property-main">
				<div class="property-header">
					<div class="property-title">
						<h4>{{$propertie->categorie->categorie_nom}}</h4>
            <div class="property-price-single right">${{$propertie->prix}} <span>Per Month</span></div>
            ...
            <div class="clear"></div>
					...
					<div class="property-single-tags">
						...
						<div class="property-type right">Property Type: <a href="#">{{$propertie->categorie->categorie_nom}}</a></div>
					</div>
				</div>

				<table class="property-details-single">
					<tr>
						<td><i class="fa fa-bed"></i> <span>{{$propertie->nombre_piece}}</span> Piece</td>
						<td><i class="fa fa-tint"></i> <span>{{$propertie->nombre_bain}} </span> Bain</td>
						<td><i class="fa fa-expand"></i> <span>{{$propertie->surface}} </span>m²</td>
						<td><i class="fa fa-car"></i> <span>{{$propertie->garages}} </span> Garages</td>
					</tr>
				</table>
        ...
        <div class="property-gallery">
          ...
          <div class="slider slider-property-gallery">
            ...
            @foreach ($propertie->photos as $photo)
              <div class="slide"><img src="{{asset('front/image_projet')}}/{{$photo->nom_image}}" alt="" /></div>
            @endforeach
          </div>
...
<!-- Mirrored from rypecreative.com/homely/property-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Jul 2017 10:29:05 GMT -->
</html>
