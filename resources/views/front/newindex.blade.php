    ...
    <div class="col-lg-4 col-md-4 sidebar">
      ...
      <div class="widget widget-sidebar sidebar-properties advanced-search">
        ...
        <form method="post" action = "#" id="myForm">
          ...
          <select name="location" id="location" class="border">
          ...
          <select name="transaction" id="transaction" class="border">
          ...
          <select name="categorie" id="categorie" class="border">
            @foreach ($categories as $categorie)
            <option value="{{$propertie->categorie->id}}">{{$categorie->categorie_nom}}</option>
            @endforeach
          </select>
          </div>
